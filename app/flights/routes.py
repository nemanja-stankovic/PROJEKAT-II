...
@flight_router.post("/create-new-flight", response_model=FlightSchema, dependencies=[Depends(JWTSuperUserBearer())])
...
@flight_router.get("/get-flight-by-id", response_model=FlightSchema, dependencies=[Depends(JWTSuperUserBearer())])
def get_flight_by_id(flight_id: str):
    return FlightController.get_flight_by_id(flight_id)

@flight_router.get("/get-flight-by-route-id", response_model=list[FlightSchema], dependencies=[Depends(JWTSuperUserBearer())])
def get_flight_by_route_id(route_id: str):
    return FlightController.search_flights_by_route_id(route_id)

@flight_router.get("/get-number-of-available-tickets-by-flight-id", response_model=int, dependencies=[Depends(JWTClassicUserBearer())])
...
@flight_router.get("/user-view-search-flights",response_model=list[UserViewFlightSchema], dependencies=[Depends(JWTClassicUserBearer())])
...
@flight_router.put("/update-ticket-price", response_model=list[TicketSchema], dependencies=[Depends(JWTSuperUserBearer())])
...
@flight_router.delete("/delete-flight", dependencies=[Depends(JWTSuperUserBearer())])
def delete_flight_by_id(flight_id: str):
    return FlightController.delete_flight_by_id(flight_id)

@flight_router.delete("/delete-user-view-searh-flight", dependencies=[Depends(JWTSuperUserBearer())])
